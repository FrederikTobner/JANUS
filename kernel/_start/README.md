...
At the end of the assembly entry point, after the stack has been setup and the CPU has been transfered to the proper mode of execution, we call the entry point of "our C world", the function `kernel_main()`, inside the [kmain subsystem](../kmain/README.md).
