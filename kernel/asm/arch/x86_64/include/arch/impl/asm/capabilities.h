...
#define ASM_CAP_EXCEPTION_STACK_REGISTER    0 // x86_64 does not have a dedicated exception stack pointer register

// x86_64 uses a unified page table base model (CR3)
#define ASM_CAP_PAGE_TABLE_BASE_MODEL_SPLIT 0
