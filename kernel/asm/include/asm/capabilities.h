...
#else
STATIC_ASSERT(
    (ASM_CAP_PAGE_TABLE_BASE_MODEL == ASM_CAP_VAL_PAGE_TABLE_BASE_UNIFIED) ||
        (ASM_CAP_PAGE_TABLE_BASE_MODEL == ASM_CAP_VAL_PAGE_TABLE_BASE_SPLIT),
    "ASM_CAP_PAGE_TABLE_BASE_MODEL must be either ASM_CAP_PAGE_TABLE_BASE_UNIFIED or ASM_CAP_PAGE_TABLE_BASE_SPLIT");
#endif
