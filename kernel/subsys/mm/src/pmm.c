...
static u64 phys_to_frame(phys_addr_t addr);
static phys_addr_t frame_to_phys(u64 frame);
static bool pmm_is_free(u8 const * bitmap, u64 frame);
static void pmm_mark_free(u8 * bitmap, u64 frame);
static void pmm_mark_used(u8 * bitmap, u64 frame);
