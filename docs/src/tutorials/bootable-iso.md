...
A working kernel ELF that speaks Multiboot2 (has a valid header and a `_start` entry point). The [Multiboot2](../concepts/boot/multiboot2.md) concept page covers the protocol. The following host tools must be installed:
