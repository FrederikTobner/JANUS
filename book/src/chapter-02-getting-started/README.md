...
[/!side]
Unlike normal programming, where you have an operating system beneath you, we're building the OS itself. There's no standard library to link against and no runtime to handle initialization. We will be running on bare metal.
...
**Next: [Installing Development Tools](installing-tools.md)**
