...
> TODO: Consider modeling the OS after DOS to some extent (simple, single-user, single-task, and direct hardware access) in the first chapters and then transition to UNIX. First we ignore multitasking, user space, memory protection, etc.
