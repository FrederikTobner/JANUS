...
# Phase 1: Pre-project cross-compiler setup
if(NOT DEFINED JANUS_PLATFORM_PHASE OR JANUS_PLATFORM_PHASE EQUAL 1)
    set(JANUS_PLATFORM_PHASE 1 CACHE INTERNAL "")
    ...
    if(JANUS_TARGET_ARCH STREQUAL "aarch64")
        ...
        if(NOT AARCH64_GCC)
            message(FATAL_ERROR 
                "aarch64-linux-gnu-gcc not found. Install the cross-compiler:\n"
        ...
        message(STATUS "Cross-compiling for aarch64 using: ${AARCH64_GCC}")
    else()
    ...
    # Mark phase 1 complete, phase 2 needed
    set(JANUS_PLATFORM_PHASE 2 CACHE INTERNAL "" FORCE)
    set(JANUS_PLATFORM_LOADED FALSE)
    return()
endif()

# Phase 2: Post-project compiler configuration
if(JANUS_PLATFORM_PHASE EQUAL 2)
    # Compiler detection
    ...
    # Reset phase for potential reconfigure
    set(JANUS_PLATFORM_PHASE 1 CACHE INTERNAL "" FORCE)
endif()
